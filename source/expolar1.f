...
c     ##################################################################
c     ##                                                              ##
c     ##  subroutine expolar1a  --  variable polarizability via loop  ##
c     ##                                                              ##
c     ##################################################################
c
c
c     "expolar1a" calculates the variable polarizability force
c     components due to exchange polarization using a double loop
c
c
      subroutine expolar1a
      use atoms
      use bound
      use cell
      use chgpot
...
c     ##################################################################
c     ##                                                              ##
c     ##  subroutine expolar1b  --  variable polarizability via list  ##
c     ##                                                              ##
c     ##################################################################
c
c
c     "expolar1b" calculates the variable polarizability force
c     components due to exchange polarization using a neighbor list
c
c
      subroutine expolar1b
      use atoms
      use bound
      use chgpot
      use couple
...
c
c
      subroutine exrotmat (i,k,xr,yr,zr,ai,ak)
      use atoms
      use math
      use mpole
      use polpot
